...
export const GithubIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    // FIX: Corrected the malformed `viewBox` attribute. It had an extra quote.
...
export const SarLegacyLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
    <circle cx="24" cy="24" r="24" fill="url(#paint0_linear_1_2)" />
    <path d="M24 33C28.9706 33 33 28.9706 33 24C33 19.0294 28.9706 15 24 15C19.0294 15 15 19.0294 15 24C15 28.9706 19.0294 33 24 33Z" stroke="white" strokeOpacity="0.5" strokeWidth="2" />
    <path d="M24 29C26.7614 29 29 26.7614 29 24C29 21.2386 26.7614 19 24 19C21.2386 19 19 21.2386 19 24C19 26.7614 21.2386 29 24 29Z" stroke="white" strokeWidth="2" />
    <defs>
...
export const SarLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
    <path d="M24 33C28.9706 33 33 28.9706 33 24C33 19.0294 28.9706 15 24 15C19.0294 15 15 19.0294 15 24C15 28.9706 19.0294 33 24 33Z" stroke="currentColor" strokeOpacity="0.5" strokeWidth="2" />
    <path d="M24 29C26.7614 29 29 26.7614 29 24C29 21.2386 26.7614 19 24 19C21.2386 19 19 21.2386 19 24C19 26.7614 21.2386 29 24 29Z" stroke="currentColor" strokeWidth="2" />
  </svg>
);
...
export const MovieIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        <path d="m20.73 6.98-4.5-2.48a1.5 1.5 0 0 0-1.74.85L12 12.85 9.51 7.36a1.5 1.5 0 0 0-1.74-.85L3.27 8.99A1.5 1.5 0 0 0 2.2 10.5v8.02a1.5 1.5 0 0 0 1.07 1.48l4.5 2.48a1.5 1.5 0 0 0 1.74-.85L12 14.15l2.49 5.49a1.5 1.5 0 0 0 1.74.85l4.5-2.48a1.5 1.5 0 0 0 1.07-1.48V8.46a1.5 1.5 0 0 0-1.07-1.48Z"/>
        <path d="m16 8 5 2.5"/>
        <path d="m3 11 4-2.5"/>
    </svg>
);
...
export const GenerateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        <path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/><path d="m19 3-9 9"/><path d="m5 17 9-9"/><path d="M21 21 12 12"/>
    </svg>
);
...
export const SpeakerOnIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
...
export const PlayIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
...
export const OpenAiIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor" focusable="false" aria-hidden="true">
        <path d="M20.285 2.143a.5.5 0 0 0-.285.428v18a.5.5 0 0 0 .5.5h.285a.5.5 0 0 0 .429-.285l2.285-4.143a.5.5 0 0 0-.428-.715h-2.143v-2.285a.5.5 0 0 0-.5-.5h-.286a.5.5 0 0 0-.5.5v2.285h-2.285a.5.5 0 0 0-.429.715l2.286 4.142a.5.5 0 0 0 .428.285h.286a.5.5 0 0 0 .5-.5v-18a.5.5 0 0 0-.285-.428zM3.715 2.143a.5.5 0 0 0-.429.286L1 6.572a.5.5 0 0 0 .428.714h2.143v2.286a.5.5 0 0 0 .5.5h.285a.5.5 0 0 0 .5-.5V9.572h2.286a.5.5 0 0 0 .428-.714L5.286 2.43A.5.5 0 0 0 4.857 2.143H3.714z" />
    </svg>
);
...
export const PlugIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        ...
        <path d="M9 17v-2.5a3.5 3.5 0 0 1 7 0V17"/>
    </svg>
);

export const GoogleDriveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        <path d="M22 10.6667L12 2L2 10.6667L6 18.3333H18L22 10.6667Z"/>
        <path d="M2 10.6667L8.5 10.6667L12 18.3333"/>
        <path d="M22 10.6667L15.5 10.6667L12 18.3333"/>
        <path d="M15 3.5L8 18.3333"/>
    </svg>
);
...
export const NotionIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        ...
        <path d="M4.5 3v18"/>
        <path d="M4.5 12H12"/>
        <path d="M12 12l7.5 6V6l-7.5 6Z"/>
    </svg>
);

export const SlackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        <path d="M12 12v2a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-2a2 2 0 0 1 2-2h2a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v2"/>
        <path d="M12 12h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2"/>
    </svg>
);
...
export const AspectRatio11Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
    <rect x="4" y="4" width="16" height="16" rx="2" />
  </svg>
);

export const AspectRatio169Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
    <rect x="2" y="7.5" width="20" height="11.25" rx="2" />
  </svg>
);

export const AspectRatio916Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
    <rect x="7.5" y="2" width="11.25" height="20" rx="2" />
  </svg>
);

export const AspectRatio43Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
    <rect x="3" y="6" width="18" height="13.5" rx="2" />
  </svg>
);

export const AspectRatio34Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
    <rect x="6" y="3" width="13.5" height="18" rx="2" />
  </svg>
);
...
export const BotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" focusable="false" aria-hidden="true">
        ...
        <path d="M9.5 10.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z" />
        <path d="M12 2a10 10 0 0 0-10 10 10 10 0 0 0 6 9.34V20a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-1.34A10 10 0 0 0 22 12 10 10 0 0 0 12 2Z" />
